...
/// Comprehensive Discord tool for messaging, reactions, and channel management
...
impl DiscordTool {
    pub fn new() -> Self {
        ...
        properties.insert(
            ...
            PropertySchema {
                schema_type: "string".to_string(),
                description: "Channel ID for readMessages, react, editMessage, deleteMessage, permissions, channelInfo".to_string(),
                default: None,
                items: None,
                enum_values: None,
            },
        ...
        DiscordTool {
            definition: ToolDefinition {
                ...
                description: "Perform Discord actions: send/read/edit/delete messages, react, check permissions, get member/role/channel info. For finding server/channel IDs by name, use discord_lookup instead.".to_string(),
...
impl Tool for DiscordTool {
    ...
    async fn execute(&self, params: Value, context: &ToolContext) -> ToolResult {
        let params: DiscordParams = match serde_json::from_value(params) {
            Ok(p) => p,
            Err(e) => return ToolResult::error(format!("Invalid parameters: {}", e)),
        };

        log::info!("Discord tool: action='{}'", params.action);
        ...
        match params.action.as_str() {
            ...
            other => ToolResult::error(format!(
                "Unknown action: '{}'. Valid actions: readMessages, sendMessage, react, editMessage, deleteMessage, searchMessages, permissions, memberInfo, roleInfo, channelInfo, channelList",
                other
            )),
        }
    }
...
impl DiscordTool {
    ...
    async fn read_messages(&self, params: &DiscordParams, context: &ToolContext) -> ToolResult {
        ...
        // Store channel_id in registry for convenience
        context.set_register("discord_channel_id", json!(channel_id), "discord");
    ...
    async fn send_message(&self, params: &DiscordParams, context: &ToolContext) -> ToolResult {
    ...
    async fn react(&self, params: &DiscordParams, context: &ToolContext) -> ToolResult {
        let channel_id = match &params.channel_id {
            Some(id) => id,
    ...
    async fn edit_message(&self, params: &DiscordParams, context: &ToolContext) -> ToolResult {
        let channel_id = match &params.channel_id {
            Some(id) => id,
    ...
    async fn delete_message(&self, params: &DiscordParams, context: &ToolContext) -> ToolResult {
        let channel_id = match &params.channel_id {
            Some(id) => id,
    ...
    async fn search_messages(&self, params: &DiscordParams, context: &ToolContext) -> ToolResult {
    ...
    async fn get_permissions(&self, params: &DiscordParams, context: &ToolContext) -> ToolResult {
        let channel_id = match &params.channel_id {
            Some(id) => id,
    ...
    async fn get_member_info(&self, params: &DiscordParams, context: &ToolContext) -> ToolResult {
        let guild_id = match &params.guild_id {
            Some(id) => id,
    ...
    async fn get_role_info(&self, params: &DiscordParams, context: &ToolContext) -> ToolResult {
        let guild_id = match &params.guild_id {
            Some(id) => id,
    ...
    async fn get_channel_info(&self, params: &DiscordParams, context: &ToolContext) -> ToolResult {
        let channel_id = match &params.channel_id {
            Some(id) => id,
    ...
    async fn get_channel_list(&self, params: &DiscordParams, context: &ToolContext) -> ToolResult {
        let guild_id = match &params.guild_id {
            Some(id) => id,
        ...
        context.set_register("discord_server_id", json!(guild_id), "discord");
